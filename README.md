...
<p align="center">
  <img height="20" src="https://img.shields.io/badge/version-v1.1.5-7C5CFF?style=flat" alt="Version"/>
...
**Dizzy** is a unified, high-performance streaming client built with Flutter. It brings together movies, series, anime, live IPTV, music, manga, and audiobooks into a fluid, custom Liquid Glass interface with hardware-accelerated playback.
...
Download the latest releases for all platforms from the [Releases](https://github.com/Sirius6907/Dizzy-v3/releases) page:

| Platform | Format |
|:---------|:-------|
| **Android** | Split APKs (`arm64-v8a`, `armeabi-v7a`, `x86_64`) & Universal APK |
...
Requirements: Flutter 3.x (Dart 3.11+)
