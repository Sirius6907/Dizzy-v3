...
/// Pure-Dart VidAPI Stream Scraper.
///
...
class VidApiScraper extends StreamScraper {
  ...
  Stream<StreamSource> scrapeStream({
    ...
    try {
      ...
      if (tmdbId == null) {
        if (kDebugMode) AppLog.d('[VidApiScraper] Could not resolve TMDB ID for "$title"');
        return;
      }
      ...
      if (kDebugMode) AppLog.d('[VidApiScraper] error: $e');
    }
  }
}
